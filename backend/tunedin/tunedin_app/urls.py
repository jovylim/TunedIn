...
urlpatterns = [
    ...
    path('get-one-user-followers/<str:pk>', views.OneUserFollowers.as_view(), name='one-user-followers'),
    path('get-one-user-following/<str:pk>', views.OneUserFollowing.as_view(), name='one-user-following'),
